...
import LoginInput from './LoginInput'; // Sesuaikan path file komponenmu

/**
 * Testing Scenarios for LoginInput:
 * 1. should handle email typing correctly
 * 2. should handle password typing correctly
 * 3. should call login function with correct arguments when button is clicked
 */
